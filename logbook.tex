...
%%%%% USER CONFIGURATION %%%%%
\newcommand{\userName}{Matias Quintana}
\newcommand{\userId}{MQ}
...
\begin{figure}[h]
    \includegraphics[width=0.6\textwidth]{img/PCG_ECG}
    \centering
...
\begin{figure}[htp]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/accuracy_128.png}
        \caption{Average accuracies for 128-bit key}
    \end{subfigure}
    \hspace{.35cm}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/accuracy_192.png}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/accuracy_256.png}
